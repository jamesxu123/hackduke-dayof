...
let mentorshipLeftTitles = ['Software Innovation in Healthcare', '', '', 'Inequality Track Talk', '']
let mentorshipLeftTimes = ['Saturday Oct 28, 1:30 pm', '', '', 'Saturday Oct 28, 1:30 pm', '']
let mentorshipLeftLocations = ['Schiciano B', '', '', 'Hudson 208', '']
let mentorshipLeftSpeakers = ['KEVIN CAVES', 'TANMAY GOKHALE', 'THOMAS LI', 'Elissa Shevinsky', 'In Prototyping Equality: Building Apps to Solve Social Issues']
