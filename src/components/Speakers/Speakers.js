...
let mentorshipLeftTitles = ['Energy And Environment Track Talk', '', 'Education Issues and Innovation']
let mentorshipLeftTimes = ['Saturday Oct 28, 1:30 pm', '', 'Saturday Oct 28, 1:30 pm']
let mentorshipLeftLocations = ['Hudson 207', '', 'Schiciano A']
let mentorshipLeftSpeakers = ['TYLER WAKEFIELD', 'DR. CHRIS WEDDING', '4 PANELISTS']
...
let mentorshipRightTitles = ['Software Innovation in Healthcare', '', '', 'Inequality Track Talk', '']
let mentorshipRightTimes = ['Saturday Oct 28, 1:30 pm', '', '', 'Saturday Oct 28, 1:30 pm', '']
let mentorshipRightLocations = ['Schiciano B', '', '', 'Hudson 208', '']
let mentorshipRightSpeakers = ['KEVIN CAVES', 'TANMAY GOKHALE', 'THOMAS LI', 'ELISSA SHEVINSKY', 'In Prototyping Equality: Building Apps to Solve Social Issues']
