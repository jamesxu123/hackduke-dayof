...
let sunTitles = ['Midnight Snack','MLH Cup Stacking','Nerf Gun War','Breakfast + Coffee','Massage Stations','Lunch','Hacking Ends','Expo #1','Expo #2', 'Closing Ceremony']
