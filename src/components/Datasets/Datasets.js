        ...
        <div className={eventInfoClasses.container}>
            ...
            <Col md={6}>
              <div className={classes.leftColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'ALL DUKE ENERGY INITIATIVE DATASETS'}
                    blurb={'Energy Data Analytics Lab curates a wide selection of energy-related datasets that can be found here'}
              ...
              <div className={classes.rightColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'AIR EMISSIONS FROM POWER PLANTS'}
                    blurb={'EPA’s website for the Air Markets Program data with information on air emissions from power plants'}
          ...
          <Row>
              ...
              <div className={classes.leftColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'BUILDING HEIGHT AND ROAD DETECTION'}
                    blurb={'Aerial imagery object identification dataset for building and road detection, and building height estimation: (can be used for localized estimates of energy consumption)'}
            ...
            <Col md={6}>
              <div className={classes.rightColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'ENERGY USE DATA FOR K-4 FORM'}
                    blurb={'Shows K-4 lighting consumption in 15 minute intervals (there are multiple lighting panels serving the building)'}
                    url={'https://drive.google.com/file/d/0B9pIN6LxBW91VHJGa2tFVS1lYnM/view?usp=sharing'} />
                </div>
              </div>
            </Col>
          </Row>
          <Row>
            <Col md={6}>
              <div className={classes.leftColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'AERIAL IMAGERY OBJECT IDENTIFICATION'}
                    blurb={'Used for for building and road detection, and building height estimation. For 25 locations across 9 U.S. cities, this dataset provides (1) high resolution aerial imagery; (2) annotations of over 40,000 building footprints (OSM shapefiles) as well as road polylines; and (3) topographical height data (LIDAR).'}
            ...
            <Col md={6}>
              <div className={classes.rightColumnContainer}>
                <div className={classes.contentContainer}>
                  <DatasetElement header={'ENERGY USE DATA FOR CIEMAS'}
                    blurb={'Shows CIEMAS energy consumption data in 15 minute intervals'}
                    url={'https://drive.google.com/file/d/0B9pIN6LxBW91elZOeGFmbGVjUDg/view?usp=sharing'} />
                </div>
              </div>
            </Col>
          </Row>
